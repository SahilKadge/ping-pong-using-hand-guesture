...
class HandDetector():
    ...
    def __init__(self, mode=False, max_Hands=2, mcomplexity = 1, detectionCon=0.5, trackCon=0.5):
        self.mode = mode # mode of detection, either false for low complexity and True for high complexity  
        self.max_Hands = max_Hands # max number of hand that should be detected 
        self.mcomplexity = mcomplexity # complexity of the model,,, low complexity is good for low end devices 
        self.detectionCon = detectionCon # detection confidence of the hand detection model 
        self.trackCon = trackCon # tracking confidence of the model 
